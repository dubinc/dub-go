...
func (r *ResponseBodyLink) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &r, "", false, []string{"id", "domain", "key", "url", "trackConversion", "archived", "proxy", "rewrite", "doIndex", "publicStats", "shortLink", "qrCode", "workspaceId", "createdAt", "updatedAt", "projectId", "webhookIds"}); err != nil {
		return err
	}
	return nil
}
