...
func (g *GetCustomerResponseBody) GetStripeCustomerID() *string {
	if g == nil {
		return nil
	}
...
func (g *GetCustomerResponseBody) GetFirstSaleAt() *string {
	if g == nil {
		return nil
	}
...
func (g *GetCustomerResponseBody) GetSubscriptionCanceledAt() *string {
	if g == nil {
		return nil
	}
