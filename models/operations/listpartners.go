...
func (l *ListPartnersResponseBody) GetUsername() *string {
	if l == nil {
		return nil
	}
	return l.Username
...
func (l *ListPartnersResponseBody) GetNetworkStatus() NetworkStatus {
	if l == nil {
...
func (l *ListPartnersResponseBody) GetIdentityVerifiedAt() *string {
	if l == nil {
		return nil
	}
	return l.IdentityVerifiedAt
}
...
func (l *ListPartnersResponseBody) GetReferralRewardID() *string {
	if l == nil {
		return nil
	}
...
func (l *ListPartnersResponseBody) GetTags() []Tags {
	if l == nil {
		return nil
	}
	return l.Tags
