...
type CreatePartnerNetworkStatus string

const (
	CreatePartnerNetworkStatusDraft     CreatePartnerNetworkStatus = "draft"
	CreatePartnerNetworkStatusSubmitted CreatePartnerNetworkStatus = "submitted"
	CreatePartnerNetworkStatusApproved  CreatePartnerNetworkStatus = "approved"
	CreatePartnerNetworkStatusRejected  CreatePartnerNetworkStatus = "rejected"
	CreatePartnerNetworkStatusTrusted   CreatePartnerNetworkStatus = "trusted"
)

func (e CreatePartnerNetworkStatus) ToPointer() *CreatePartnerNetworkStatus {
	return &e
}
func (e *CreatePartnerNetworkStatus) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "rejected":
		fallthrough
	case "trusted":
		*e = CreatePartnerNetworkStatus(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePartnerNetworkStatus: %v", v)
	}
}
...
const (
	...
	CreatePartnerDefaultPayoutMethodTremendous CreatePartnerDefaultPayoutMethod = "tremendous"
)
...
type CreatePartnerTags struct {
	ID   string `json:"id"`
	Name string `json:"name"`
}

func (c *CreatePartnerTags) GetID() string {
	if c == nil {
		return ""
	}
	return c.ID
...
func (c *CreatePartnerTags) GetName() string {
	if c == nil {
		return ""
	}
	return c.Name
...
type CreatePartnerResponseBody struct {
	...
	NetworkStatus CreatePartnerNetworkStatus `json:"networkStatus"`
	...
	Tags []CreatePartnerTags `json:"tags,omitempty"`
...
func (c *CreatePartnerResponseBody) GetUsername() *string {
	if c == nil {
		return nil
	}
	return c.Username
...
func (c *CreatePartnerResponseBody) GetNetworkStatus() CreatePartnerNetworkStatus {
	if c == nil {
		return CreatePartnerNetworkStatus("")
	}
...
func (c *CreatePartnerResponseBody) GetReferralRewardID() *string {
	if c == nil {
		return nil
	}
	return c.ReferralRewardID
}

func (c *CreatePartnerResponseBody) GetCustomRewardID() *string {
	if c == nil {
		return nil
	}
	return c.CustomRewardID
}
...
func (c *CreatePartnerResponseBody) GetTags() []CreatePartnerTags {
	if c == nil {
		return nil
	}
	return c.Tags
