...
const (
	NetworkStatusDraft     NetworkStatus = "draft"
	NetworkStatusSubmitted NetworkStatus = "submitted"
	NetworkStatusApproved  NetworkStatus = "approved"
	NetworkStatusRejected  NetworkStatus = "rejected"
	NetworkStatusTrusted   NetworkStatus = "trusted"
)
...
func (p *PartnerEnrolledEventData) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &p, "", false, []string{"id", "name", "networkStatus", "programId", "partnerId", "createdAt", "status"}); err != nil {
		return err
	}
	return nil
}
...
func (p *PartnerEnrolledEventData) GetUsername() *string {
	if p == nil {
		return nil
	}
	return p.Username
...
func (p *PartnerEnrolledEventData) GetNetworkStatus() NetworkStatus {
	if p == nil {
...
func (p *PartnerEnrolledEventData) GetReferralRewardID() *string {
	if p == nil {
		return nil
	}
...
func (p *PartnerEnrolledEventData) GetTags() []Tags {
	if p == nil {
		return nil
	}
	return p.Tags
