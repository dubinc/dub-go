...
func (p *PartnerEnrolledEventData) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &p, "", false, []string{"id", "name", "companyName", "email", "image", "country", "paypalEmail", "stripeConnectId", "payoutsEnabledAt", "programId", "partnerId", "tenantId", "createdAt", "status", "links"}); err != nil {
		return err
	}
	return nil
}
...
func (p *PartnerEnrolledEventData) GetClicks() *float64 {
	if p == nil {
		return nil
	}
	return p.Clicks
...
func (p *PartnerEnrolledEventData) GetLeads() *float64 {
	if p == nil {
		return nil
	}
	return p.Leads
...
func (p *PartnerEnrolledEventData) GetConversions() *float64 {
	if p == nil {
		return nil
	}
	return p.Conversions
...
func (p *PartnerEnrolledEventData) GetSales() *float64 {
	if p == nil {
		return nil
	}
	return p.Sales
...
func (p *PartnerEnrolledEventData) GetSaleAmount() *float64 {
	if p == nil {
		return nil
	}
	return p.SaleAmount
