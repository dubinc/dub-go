...
func (c *Customer) GetFirstSaleAt() *string {
	if c == nil {
		return nil
	}
	return c.FirstSaleAt
}

func (c *Customer) GetSubscriptionCanceledAt() *string {
	if c == nil {
		return nil
	}
	return c.SubscriptionCanceledAt
}
...
func (l *LeadCreatedEventLink) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &l, "", false, []string{"id", "domain", "key", "url", "trackConversion", "archived", "proxy", "rewrite", "doIndex", "publicStats", "shortLink", "qrCode", "workspaceId", "createdAt", "updatedAt", "projectId", "webhookIds"}); err != nil {
		return err
	}
	return nil
}
...
func (l *LeadCreatedEventLink) GetDisabledAt() *string {
	if l == nil {
		return nil
	}
	return l.DisabledAt
...
func (l *LeadCreatedEventLink) GetTags() []LinkTagSchema {
	if l == nil {
		return nil
	}
	return l.Tags
