...
func CreateWebhookEventDiscountCodeWebhookEvent(discountCodeWebhookEvent DiscountCodeWebhookEvent) WebhookEvent {
	typ := WebhookEventTypeDiscountCodeWebhookEvent
...
func (u *WebhookEvent) UnmarshalJSON(data []byte) (err error) {
	...
	*u = WebhookEvent{}
	...
	var discountCodeWebhookEvent DiscountCodeWebhookEvent = DiscountCodeWebhookEvent{}
	if err := utils.UnmarshalJSON(data, &discountCodeWebhookEvent, "", true, nil); err == nil {
		u.DiscountCodeWebhookEvent = &discountCodeWebhookEvent
		u.Type = WebhookEventTypeDiscountCodeWebhookEvent
		return nil
	}
...
func (u WebhookEvent) MarshalJSON() ([]byte, error) {
	...
	if u.DiscountCodeWebhookEvent != nil {
		return utils.MarshalJSON(u.DiscountCodeWebhookEvent, "", true)
	}
