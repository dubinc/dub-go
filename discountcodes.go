...
func newDiscountCodes(rootSDK *Dub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *DiscountCodes {
...
func (s *DiscountCodes) List(ctx context.Context, request operations.ListDiscountCodesRequest, opts ...operations.Option) ([]components.DiscountCodeSchema, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/discount-codes")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.DiscountCodeSchema
...
func (s *DiscountCodes) Create(ctx context.Context, request *operations.CreateDiscountCodeRequestBody, opts ...operations.Option) (*components.DiscountCodeSchema, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *DiscountCodes) Delete(ctx context.Context, idOrCode string, opts ...operations.Option) (*operations.DeleteDiscountCodeResponseBody, error) {
	request := operations.DeleteDiscountCodeRequest{
		IDOrCode: idOrCode,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/discount-codes/{idOrCode}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.DeleteDiscountCodeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
