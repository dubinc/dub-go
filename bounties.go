...
func newBounties(rootSDK *Dub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Bounties {
	return &Bounties{
		rootSDK:          rootSDK,
...
func (s *Bounties) ListSubmissions(ctx context.Context, request operations.ListBountySubmissionsRequest, opts ...operations.Option) ([]operations.ListBountySubmissionsResponseBody, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/bounties/{bountyId}/submissions", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []operations.ListBountySubmissionsResponseBody
...
// ApproveSubmission - Approve a bounty submission
...
func (s *Bounties) ApproveSubmission(ctx context.Context, request operations.ApproveBountySubmissionRequest, opts ...operations.Option) (*operations.ApproveBountySubmissionResponseBody, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/bounties/{bountyId}/submissions/{submissionId}/approve", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ApproveBountySubmissionResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// RejectSubmission - Reject a bounty submission
...
func (s *Bounties) RejectSubmission(ctx context.Context, request operations.RejectBountySubmissionRequest, opts ...operations.Option) (*operations.RejectBountySubmissionResponseBody, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/bounties/{bountyId}/submissions/{submissionId}/reject", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.RejectBountySubmissionResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
