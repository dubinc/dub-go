...
func (s *Tags) List(ctx context.Context) (*operations.GetTagsResponse, error) {
...
func (s *Tags) Create(ctx context.Context, tag string, color *operations.Color) (*operations.CreateTagResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
