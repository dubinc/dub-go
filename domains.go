...
func (s *Domains) Delete(ctx context.Context, slug string) (*operations.DeleteDomainResponseBody, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Domains) Update(ctx context.Context, slug string, requestBody *operations.UpdateDomainRequestBody) (*components.DomainSchema, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
