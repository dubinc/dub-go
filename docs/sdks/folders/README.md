...
**[*components.FolderSchema](../../models/components/folderschema.md), error**
...
**[[]components.FolderSchema](../../.md), error**
...
**[*operations.DeleteFolderResponseBody](../../models/operations/deletefolderresponsebody.md), error**
