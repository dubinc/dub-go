...
<!-- UsageSnippet language="go" operationID="deactivatePartner" method="post" path="/partners/deactivate" -->
```go
package main
...
func main() {
    ...
    res, err := s.Partners.Deactivate(ctx, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*operations.DeactivatePartnerResponseBody](../../models/operations/deactivatepartnerresponsebody.md), error**
