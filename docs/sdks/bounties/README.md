...
<!-- UsageSnippet language="go" operationID="listBountySubmissions" method="get" path="/bounties/{bountyId}/submissions" -->
```go
package main
...
**[[]operations.ListBountySubmissionsResponseBody](../../.md), error**
...
<!-- UsageSnippet language="go" operationID="approveBountySubmission" method="post" path="/bounties/{bountyId}/submissions/{submissionId}/approve" -->
```go
package main
...
func main() {
    ...
    res, err := s.Bounties.ApproveSubmission(ctx, operations.ApproveBountySubmissionRequest{
        BountyID: "<id>",
        SubmissionID: "<id>",
    })
    if err != nil {
...
**[*operations.ApproveBountySubmissionResponseBody](../../models/operations/approvebountysubmissionresponsebody.md), error**
...
<!-- UsageSnippet language="go" operationID="rejectBountySubmission" method="post" path="/bounties/{bountyId}/submissions/{submissionId}/reject" -->
```go
package main
...
func main() {
    ...
    res, err := s.Bounties.RejectSubmission(ctx, operations.RejectBountySubmissionRequest{
        BountyID: "<id>",
        SubmissionID: "<id>",
    })
    if err != nil {
...
**[*operations.RejectBountySubmissionResponseBody](../../models/operations/rejectbountysubmissionresponsebody.md), error**
